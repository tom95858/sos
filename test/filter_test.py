...
class FilterTest(SosTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.schema.from_template('filter_test',
                                 ...
                                 { "name" : "string", "type" : "char_array", "index" : {}, "size" : 32 },
                                 { "name" : "byte_array", "type" : "byte_array", "index" : {}, "size" : 32 },
                                 { "name" : "int16_array", "type" : "int16_array", "index" : {}, "size" : 32 },
                                 { "name" : "int32_array", "type" : "int32_array", "index" : {}, "size" : 32 },
                                 { "name" : "int64_array", "type" : "int64_array", "index" : {}, "size" : 32 },
                                 { "name" : "uint16_array", "type" : "uint16_array", "index" : {}, "size" : 32 },
                                 { "name" : "uint32_array", "type" : "uint32_array", "index" : {}, "size" : 32 },
                                 { "name" : "uint64_array", "type" : "uint64_array", "index" : {}, "size" : 32 },
                                 { "name" : "float_array", "type" : "float_array", "index" : {}, "size" : 32 },
                                 { "name" : "double_array", "type" : "double_array", "index" : {}, "size" : 32 },
